...
<html lang="fi">
  ...
  <script>
    $(document).ready(function() {
        ...
        <div class="container-fluid">
          ...
          <div class="navbar-collapse collapse">
            <ul id="nav" class="nav navbar-nav navbar-right text-uppercase">
              <li><a href="#sect-naytelma">Näytelmä</a></li>
              <li><a href="#sect-juhla">Vuosijuhla</a></li>
              <li><a href="http://kauppa.speksi25.com/" class="external">Liput</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div><!--/.container-fluid -->
      </nav>
      ...
      <div class="row nomargin image-bar-container">
        ...
        <div id="sect-naytelma" class="section"></div>
  		...
  		<div id="naytelma" class="row row-centered nomargin content-bar">
        ...
        <p>
          <a href="http://kauppa.speksi25.com/" class="btn btn-default btn-lg" role="button">Osta lippuja</a>
    ...
    <div class="row nomargin image-bar-container">
      ...
      <div id="juhla" class="row row-centered nomargin content-bar">
        <div class="col-lg-1 col-centered"></div>
        <div class="col-xs-12 col-sm-9 col-lg-8 col-centered">
          <h2>Teekkarispeksin 25-vuotisjuhlagaala 18.10.2014</h2>
          <p>
      ...
      <div id="bw" class="row row-centered nomargin content-bar">
        <div class="col-lg-1 col-centered"></div>
        <div class="col-xs-12 col-sm-9 col-lg-8 col-centered">
          <h2>Yleistä tietoa</h2>
          <p>
            Put a bird on it flannel mlkshk before they sold out tattooed, Banksy Blue Bottle Wes Anderson. Helvetica Pinterest hella brunch. Forage slow-carb rganic, biodiesel typewriter cred Brooklyn butcher deep v sartorial authentic. Viral post-ironic Wes Anderson pop-up. Bushwick tousled Tonx Thundercats, XOXO drinking vinegar lo-fi sustainable actually cliche flannel squid. Ethnic brunch church-key Pinterest. Ethnic readymade 8-bit XOXO pork belly, single- origin coffee fingerstache farm-to-table jean shorts Banksy iPhone paleo vinyl quinoa sustainable.
          </p>
        </div>
      </div>
	</div>
